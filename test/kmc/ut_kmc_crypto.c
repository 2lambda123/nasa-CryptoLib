...
/**
 *  Unit Tests that make use of TC_ApplySecurity/TC_ProcessSecurity function on
 *the data with KMC Crypto Service/MariaDB Functionality Enabled.
 **/
#include "crypto.h"
...
// /**
//  * @brief Unit Test: Nominal Encryption with KMC Crypto Service && JPL Unit
//  Test MariaDB
//  **/
...
//     Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0003, 55, TC_HAS_FECF,
//     TC_NO_SEGMENT_HDRS, 1024, AOS_FHEC_NA, AOS_IZ_NA, 0); int32_t status =
//     Crypto_Init();
...
//     hex_conversion(raw_tc_jpl_mmt_scid44_vcid1,
//     &raw_tc_jpl_mmt_scid44_vcid1_expect,
...
//     status = Crypto_TC_ApplySecurity((uint8_t*
//     )raw_tc_jpl_mmt_scid44_vcid1_expect,
...
//     ASSERT_EQ(CRYPTO_LIB_SUCCESS, status);
// }
// //// Commenting out test - AEAD algorithms must have a tag -- Enc only config
// is invalid
// ///**
// // * @brief Unit Test: Nominal Encryption with KMC Crypto Service && JPL Unit
// Test MariaDB
...
// //{
// //    // Setup & Initialize CryptoLib
// //    Crypto_Config_CryptoLib(KEY_TYPE_KMC, MC_TYPE_DISABLED,
// SA_TYPE_MARIADB, CRYPTOGRAPHY_TYPE_KMCCRYPTO,
// //                            IV_INTERNAL, CRYPTO_TC_CREATE_FECF_TRUE,
// TC_PROCESS_SDLS_PDUS_FALSE, TC_NO_PUS_HDR,
// //                            TC_IGNORE_SA_STATE_FALSE,
...
// //                            TC_CHECK_FECF_TRUE, 0x3F,
// SA_INCREMENT_NONTRANSMITTED_IV_TRUE);
// //    Crypto_Config_MariaDB("sa_user", "sa_password", "localhost","sadb",
// 3306, CRYPTO_FALSE, NULL, NULL, NULL, NULL, 0, NULL);
// //    Crypto_Config_Kmc_Crypto_Service("https",
// "asec-cmdenc-srv1.jpl.nasa.gov", 8443, "crypto-service",
...
// //    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x002C, 0, TC_HAS_FECF,
// TC_NO_SEGMENT_HDRS, 1024, AOS_FHEC_NA, AOS_IZ_NA, 0);
// //    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x002C, 1, TC_HAS_FECF,
// TC_NO_SEGMENT_HDRS, 1024, AOS_FHEC_NA, AOS_IZ_NA, 0);
// //    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x002C, 2, TC_HAS_FECF,
// TC_NO_SEGMENT_HDRS, 1024, AOS_FHEC_NA, AOS_IZ_NA, 0);
// //    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x002C, 3, TC_HAS_FECF,
// TC_NO_SEGMENT_HDRS, 1024, AOS_FHEC_NA, AOS_IZ_NA, 0);
...
//     "crypto-service","/certs/ammos-ca-bundle.crt",NULL, CRYPTO_TRUE,
//     CLIENT_CERTIFICATE, "PEM", CLIENT_CERTIFICATE_KEY, NULL, NULL);
//     Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0003, 56, TC_HAS_FECF,
//     TC_NO_SEGMENT_HDRS, 1024, AOS_FHEC_NA, AOS_IZ_NA, 0); int32_t status =
//     Crypto_Init();
...
//     "2003DC250000130000000000000000000000016746C816E9C1D758FB457D8AAE7A5B83842A5A";
...
//     &enc_tc_jpl_mmt_scid44_vcid1_expect,
...
//     status = Crypto_TC_ProcessSecurity((uint8_t*
//     )enc_tc_jpl_mmt_scid44_vcid1_expect,
//     &enc_tc_jpl_mmt_scid44_vcid1_expect_len, tc_processed_frame); if(status
//     != CRYPTO_LIB_SUCCESS)
//     {
//         Crypto_Shutdown();
//     }
...
// //
// //    char* enc_tc_jpl_mmt_scid44_vcid1=
// "202C0816000003000000000000000000000001669CD238";
// //    char* enc_tc_jpl_mmt_scid44_vcid1_expect = NULL;
// //    int enc_tc_jpl_mmt_scid44_vcid1_expect_len = 0;
// //
// //    // IV = 000000000000000000000001
...
// tc_processed_frame);
// //    // ASSERT_EQ(CRYPTO_LIB_SUCCESS, status);
// //    // Expected to fail -- KMC Crypto Service doesn't support AES/GCM with
// no AAD/MAC
...
//  * @brief Unit Test: Nominal Encryption with KMC Crypto Service && JPL Unit
//  Test MariaDB
//  * This doesn't work -- Apply Security Auth Only doesn't return the proper
//  tag.
//  **/
...
//     char* enc_tc_jpl_mmt_scid44_vcid1=
//     "2003E02600001400000000000000000000000200018DC038398EAA968C0D8972A614E1EFE005AE";
//     char* enc_tc_jpl_mmt_scid44_vcid1_expect = NULL;
//     int enc_tc_jpl_mmt_scid44_vcid1_expect_len = 0;
...
//     }
//     ASSERT_EQ(CRYPTO_LIB_SUCCESS, status);
//     // Expected to fail -- KMC doesn't support 0 cipher text input for
//     decrypt function.
//     // ASSERT_EQ(CRYPTOGRAHPY_KMC_CRYPTO_SERVICE_GENERIC_FAILURE, status);
//     printf("Processed PDU:\n");
//     for (int i=0; i<tc_processed_frame->tc_pdu_len; i++)
...
//     "crypto-service","/certs/ammos-ca-bundle.crt",NULL, CRYPTO_TRUE,
//     CLIENT_CERTIFICATE, "PEM", CLIENT_CERTIFICATE_KEY, NULL, NULL);
//     Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0003, 57, TC_HAS_FECF,
//     TC_NO_SEGMENT_HDRS, 1024, AOS_FHEC_NA, AOS_IZ_NA, 0); int32_t status =
//     Crypto_Init();
...
// //     char* enc_tc_jpl_mmt_scid44_vcid1=
// "2003E41E0000150000000000000000000000040001EF029857C5ED7E5B1807";
// //     char* enc_tc_jpl_mmt_scid44_vcid1_expect = NULL;
// //     int enc_tc_jpl_mmt_scid44_vcid1_expect_len = 0;
...
// // UTEST(KMC_CRYPTO,
// UNHAPPY_PATH_INVALID_MAC_PROCESS_SEC_ENC_AND_AUTH_AESGCM_8BYTE_MAC)
// // {
// //     // Setup & Initialize CryptoLib
// //     Crypto_Config_CryptoLib(KEY_TYPE_KMC, MC_TYPE_DISABLED,
// SA_TYPE_MARIADB, CRYPTOGRAPHY_TYPE_KMCCRYPTO,
...
// "crypto-service","/certs/ammos-ca-bundle.crt",NULL, CRYPTO_TRUE,
// CLIENT_CERTIFICATE, "PEM", CLIENT_CERTIFICATE_KEY, NULL, NULL);
// //     Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0003, 11, TC_HAS_FECF,
// TC_NO_SEGMENT_HDRS, 1024, AOS_FHEC_NA, AOS_IZ_NA, 0);
// //     int32_t status = Crypto_Init();

// //     char* enc_tc_jpl_mmt_scid44_vcid1=
// "20032C1E000009000000000000000000000001669C5639DCCDEA8C6CE3EEF2";
// //     char* enc_tc_jpl_mmt_scid44_vcid1_expect = NULL;
// //     int enc_tc_jpl_mmt_scid44_vcid1_expect_len = 0;
...
// "crypto-service","/certs/ammos-ca-bundle.crt",NULL, CRYPTO_TRUE,
// CLIENT_CERTIFICATE, "PEM", CLIENT_CERTIFICATE_KEY, NULL, NULL);
// //     Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0003, 12, TC_HAS_FECF,
// TC_NO_SEGMENT_HDRS, 1024, AOS_FHEC_NA, AOS_IZ_NA, 0);
// //     int32_t status = Crypto_Init();
...
// //         Crypto_Shutdown();
// //     }
// //     // we expect an InvalidAlgorithmParameterException for macLength of
// that size.
// //     ASSERT_EQ(CRYPTOGRAHPY_KMC_CRYPTO_SERVICE_GENERIC_FAILURE, status);
