...
UTEST(CRYPTO_C, CALC_CRC16) {
  ...
  char *data_h =
      "2003002000ff000100001880d2c9000e197f0b001b0004000400003040d95e";
  uint8_t *data_b = NULL;
  int data_b_len = 0;
...
UTEST(CRYPTO_C, BAD_CC_FLAG) {
  ...
  char *raw_tc_sdls_ping_h =
      "3003002000ff000100001880d2c9000e197f0b001b0004000400003040d95ea61a";
...
UTEST(CRYPTO_C, PDU_SWITCH) {
  ...
  // TODO:  (RB) Disabled for now.  Key Inventory needs to be re-worked. - Not
  // currently using EP
