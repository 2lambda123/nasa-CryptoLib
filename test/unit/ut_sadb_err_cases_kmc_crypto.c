...
/**
 * @brief Unit Test: Nominal Encryption with KMC Crypto Service && JPL Unit Test
 *MariaDB
 **/
UTEST(KMC_CRYPTO, ONLY_KEYED_SA_AVAILABLE_FOR_GVCID) {
  // Setup & Initialize CryptoLib
  Crypto_Config_CryptoLib(
      KEY_TYPE_KMC, MC_TYPE_INTERNAL, SA_TYPE_MARIADB,
      CRYPTOGRAPHY_TYPE_KMCCRYPTO, IV_INTERNAL, CRYPTO_TC_CREATE_FECF_TRUE,
  ...
  Crypto_Config_MariaDB("db-itc-kmc.nasa.gov", "sadb", 3306, CRYPTO_TRUE,
                        CRYPTO_TRUE, "/certs/ammos-ca-bundle.crt", NULL,
                        CLIENT_CERTIFICATE, CLIENT_CERTIFICATE_KEY, NULL,
                        "root", NULL);
  ...
  status = Crypto_TC_ApplySecurity(
      (uint8_t *)raw_tc_jpl_mmt_scid44_vcid1_expect,
...
UTEST(KMC_CRYPTO, ONLY_UNKEYED_SA_AVAILABLE_FOR_GVCID) {
  ...
  //    TC_NO_SEGMENT_HDRS, 1024, AOS_FHEC_NA, AOS_IZ_NA, 0);
  // Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x002C, 32, TC_HAS_FECF,
  // TC_NO_SEGMENT_HDRS, TC_OCF_NA, 1024, AOS_FHEC_NA, AOS_IZ_NA, 0);
  GvcidManagedParameters_t TC_UT_Managed_Parameters = {
      0,           0x002c,    32, TC_HAS_FECF,
      AOS_FHEC_NA, AOS_IZ_NA, 0,  TC_NO_SEGMENT_HDRS,
      1024,        TC_OCF_NA, 1};
  Crypto_Config_Add_Gvcid_Managed_Parameters(TC_UT_Managed_Parameters);
  int32_t status = Crypto_Init();
...
UTEST(KMC_CRYPTO, NULL_EKID_BLANK_ECS_ERROR) {
  ...
  //    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x002C, 3, TC_HAS_FECF,
  //    TC_NO_SEGMENT_HDRS, 1024, AOS_FHEC_NA, AOS_IZ_NA, 0);
  // Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x002C, 34, TC_HAS_FECF,
  // TC_NO_SEGMENT_HDRS, TC_OCF_NA, 1024, AOS_FHEC_NA, AOS_IZ_NA, 0);
  GvcidManagedParameters_t TC_UT_Managed_Parameters = {
      0,           0x0003,    34, TC_HAS_FECF,
      AOS_FHEC_NA, AOS_IZ_NA, 0,  TC_NO_SEGMENT_HDRS,
      1024,        TC_OCF_NA, 1};
  Crypto_Config_Add_Gvcid_Managed_Parameters(TC_UT_Managed_Parameters);
  int32_t status = Crypto_Init();
...
UTEST(KMC_CRYPTO, INVALID_ABM_LENGTH_FOR_FRAME_WITH_SEG_HEADERS) {
  ...
  //    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x002C, 3, TC_HAS_FECF,
  //    TC_NO_SEGMENT_HDRS, 1024, AOS_FHEC_NA, AOS_IZ_NA, 0);
  // Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x002C, 28, TC_HAS_FECF,
  // TC_HAS_SEGMENT_HDRS, TC_OCF_NA, 1024, AOS_FHEC_NA, AOS_IZ_NA, 0);

  GvcidManagedParameters_t TC_UT_Managed_Parameters = {
      0,           0x002c,    28, TC_HAS_FECF,
